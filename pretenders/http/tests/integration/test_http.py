...
def test_configure_multiple_rules_independent():
    ...
    """
    http_mock.reset_all()
    add_test_preset('/test_200', status=200)
    add_test_preset('/test_400', status=400)
    add_test_preset('/test_500', status=500)
    add_test_preset('/test_410', status=410)
...
def test_multiple_responses_for_a_url():
    ...
    http_mock.reset_all()
    add_test_preset('/test_url_pattern', status=200)
    add_test_preset('/test_url_pattern_2', status=201)
    add_test_preset('/test_url_pattern', status=301)
    add_test_preset('/test_url_pattern', status=410)
...
def test_regular_expression_matching():
    ...
    http_mock.reset_all()
    for i in range(5):
        add_test_preset(url, status=200)
